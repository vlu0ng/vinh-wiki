---
title: "Answered Questions Registry"
date: 2026-05-19
tags: [system, registry]
---

# Answered Questions Registry

Tracks which `## Open Questions` have been answered, by which page(s), on which date. Used by the `vinh-wiki-answer-questions` skill to avoid re-answering the same question.

## Entries

| Date | Source Page | Question | Pages Created / Updated |
|---|---|---|---|
| 2026-05-19 | wiki/concepts/disposition-vs-knowledge.md | Is there a minimal set of practices (journaling, forecasting, decision review) that reliably builds disposition rather than just knowledge? | wiki/concepts/disposition-building-practices.md (created) |
| 2026-05-19 | wiki/concepts/latticework-pedagogy.md | Does forecasting practice (as in Philip Tetlock's superforecaster research) produce meaningful latticework-like integration? | wiki/concepts/superforecasting.md (created) |
| 2026-05-19 | wiki/topics/tuberculosis-and-global-health.md | What can TB's history teach us about COVID-19, HIV, and future pandemics? | wiki/concepts/pandemic-lessons-from-tb.md (created) |
| 2026-05-19 | wiki/concepts/romanticization-of-illness.md | Does Sontag's prescription — strip all metaphor from illness — leave patients without useful narrative tools for coping? | wiki/concepts/illness-narrative-and-coping.md (created) |
| 2026-05-19 | wiki/topics/living-and-working-with-ai.md | At what point does AI augmentation shade into cognitive atrophy — do we lose skills by outsourcing them? | wiki/concepts/cognitive-atrophy-and-ai.md (created) |
| 2026-05-19 | wiki/concepts/disposition-vs-knowledge.md | How much of Munger's dispositional advantage was formed before age 30 versus cultivated deliberately in adulthood? | wiki/concepts/munger-disposition-formation.md (created) |
| 2026-05-19 | wiki/concepts/latticework-pedagogy.md | What is the minimum viable feedback loop for latticework development outside investing? | wiki/concepts/latticework-feedback-loops-outside-investing.md (created) |
| 2026-05-19 | wiki/topics/tuberculosis-and-global-health.md | What would full TB eradication require politically and financially? | wiki/concepts/tb-eradication-requirements.md (created) |
| 2026-05-19 | wiki/topics/living-and-working-with-ai.md | Where is the jagged frontier for any given profession, and how should workers invest their mapping efforts? | wiki/concepts/mapping-the-jagged-frontier.md (created) |
| 2026-05-19 | wiki/concepts/romanticization-of-illness.md | Which contemporary diseases carry romanticized framings? (Depression as "creative sensitivity"? Autoimmune disease?) | wiki/concepts/contemporary-romanticized-illnesses.md (created) |
| 2026-05-20 | wiki/concepts/disposition-vs-knowledge.md | Do wisdom traditions (Stoicism, Zen, Confucianism) that emphasize practice over doctrine outperform knowledge-focused traditions on behavioral outcomes? | wiki/concepts/wisdom-traditions-practice-vs-doctrine.md (created) |
| 2026-05-20 | wiki/topics/stoic-justice.md | How does Stoic justice interact with systemic injustice? The Stoics mostly focused on individual conduct — does the framework scale to structural critique? | wiki/concepts/stoicism-and-systemic-injustice.md (created) |
| 2026-05-20 | wiki/topics/experimental-mindset.md | How does one avoid "experiment theater" — endless exploration that avoids real commitment? | wiki/concepts/experiment-theater.md (created) |
| 2026-05-20 | wiki/topics/mental-models-and-multidisciplinary-thinking.md | Where does the latticework approach fail — what kinds of problems resist multi-model synthesis? | wiki/concepts/latticework-failure-modes.md (created) |
| 2026-05-20 | wiki/topics/the-one-thing.md | At what point does "going small" become tunnel vision that misses important signals outside your one thing? | wiki/concepts/focus-vs-orientation.md (created) |
| 2026-05-20 | wiki/topics/adaptive-leadership.md | What's the relationship between adaptive leadership and psychological safety? Heifetz emphasizes productive disequilibrium; psychological safety literature emphasizes low fear. Are these in tension? | wiki/concepts/adaptive-leadership-and-psychological-safety.md (created) |
| 2026-05-20 | wiki/topics/crony-capitalism-and-monetary-deformation.md | Does his libertarian lens cause him to underweight the systemic risks he dismisses (e.g., was 2008 actually catastrophic without intervention)? | wiki/concepts/stockman-2008-critique.md (created) |
| 2026-05-20 | wiki/topics/stoic-justice.md | What's the relationship between truth-telling and tact? Marcus advised: "Speak the truth as you see it, but with kindness. With humility. Without hypocrisy." | wiki/concepts/stoic-truth-telling-and-tact.md (created) |
| 2026-05-20 | wiki/topics/slow-productivity.md | How does this interact with cognitive-atrophy-and-ai — does AI assistance undermine the craft-building that slow productivity depends on? | wiki/concepts/slow-productivity-and-ai-craft.md (created) |
| 2026-05-20 | wiki/topics/mathematics-education.md | Is there tension between "open tasks" and the need to develop procedural fluency? | wiki/concepts/procedural-fluency-vs-open-tasks.md (created) |
| 2026-05-20 | wiki/topics/art-theft-and-obsession.md | What is the ethics of possessing beauty you cannot share? | wiki/concepts/ethics-of-private-beauty.md (created) |
| 2026-05-20 | wiki/concepts/health-equity.md | How does intellectual property law (on drugs and vaccines) perpetuate health inequity? | wiki/concepts/intellectual-property-and-health-equity.md (created) |
