...
**2026-06-25** — Full dream-cycle pass (nightly). 91 wiki pages analyzed (57 concepts, 15 topics, 19 people). Vault unchanged since 2026-06-21 weekly pass. **Stage 1:** 0 new contradictions; 8 total open contradictions confirmed. Pages scanned this run: 9 pages across four clusters — people/public-health (john-green, partners-in-health, ethan-mollick, gary-keller), AI/work (ai-productivity-gains-distribution, general-purpose-technology, mapping-the-jagged-frontier), economics (crony-capitalism, sound-money). All pages internally consistent. Two candidates explored: (1) `ai-productivity-gains-distribution` (notes AI productivity tools are increasingly accessible to individual freelancers, which may allow remaining augmented workers to capture gains) vs. `living-and-working-with-ai` — confirmed complementary, not contradictory: both pages share the same structural frame (jagged frontier, uneven diffusion); `ai-productivity-gains-distribution` extends the political economy analysis of who captures gains, not the individual practice framework of `living-and-working-with-ai`. (2) `mapping-the-jagged-frontier` continues to reinforce the expert-exemption side of existing contradiction #1 ("Senior practitioners can map aggressively and delegate broadly") — already noted in the 2026-06-12 run; not re-logged. All 8 existing contradictions remain open and unchanged. **Stage 2:** 0 new near-duplicate cases. Vault stable at 91 pages since 2026-06-14. Cases 1, 2 (17 confirmed instances), and 3 carry forward unchanged. All pending owner approval. **Stage 3:** All top-tier and mid-tier inbound-link counts re-verified via exact-string anchored ripgrep (self-reference excluded; prefix inflation avoided). All counts confirmed stable: disposition-vs-knowledge (20), mental-models (18), health-equity (17), cognitive-atrophy-and-ai (14), mental-models-and-multidisciplinary-thinking (12), charlie-munger (11), slow-productivity (11), growth-mindset (10), jagged-frontier (10), latticework-pedagogy (10), tuberculosis-and-global-health (10), experimental-mindset (9), large-language-models (9), living-and-working-with-ai (9), tiny-experiments (8), stoic-virtues (7), superforecasting (7). No rank changes.
...
All pages share a creation band of 2026-05-18 to 2026-06-14 (11–38 days old). Staleness does not yet differentiate meaningfully within this vault; pages are recent. Re-run this section after the next enrichment pass.
...
Inbound-link counts re-verified via exact-string anchored ripgrep (unique files, excluding self-references; exact-string grep used for pages whose names are prefixes of other page names to avoid inflation). Vault at 91 pages. All counts confirmed stable from 2026-06-24.
...
Nine pages scanned across four clusters: people/public-health (john-green, partners-in-health, ethan-mollick, gary-keller), AI/work (ai-productivity-gains-distribution, general-purpose-technology, mapping-the-jagged-frontier), economics (crony-capitalism, sound-money). Two candidates explored: (1) `ai-productivity-gains-distribution` (AI tools increasingly accessible to individual freelancers — gains might distribute to remaining augmented workers) vs. `living-and-working-with-ai` — confirmed complementary: both pages share the same structural frame (jagged frontier, uneven diffusion by task); `ai-productivity-gains-distribution` addresses the political economy of who captures gains at a macro level, while `living-and-working-with-ai` addresses individual practice; the two levels of analysis are additive, not contradictory. (2) `mapping-the-jagged-frontier` expert-exemption claim ("Senior practitioners can map aggressively and delegate broadly") — already noted as reinforcing the `cognitive-atrophy-and-ai` side of existing contradiction #1 in the 2026-06-12 run; not re-logged. All 8 existing contradictions remain open and unchanged.
