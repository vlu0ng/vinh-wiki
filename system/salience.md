...
**2026-07-01** — Full dream-cycle pass (nightly). 91 wiki pages analyzed (57 concepts, 15 topics, 19 people). Vault unchanged since 2026-06-14 weekly pass. **Stage 1:** 0 new contradictions; 8 total open contradictions confirmed. Pages scanned this run: 7 pages across Stockman economics cluster (david-stockman, stockman-2008-critique), conceptual tools (focusing-question, inversion), people (anne-laure-le-cunff, jessie-inchauspee), and applied economics (economic-literacy-at-scale). All clusters internally consistent. No new contradiction candidates identified. `stockman-2008-critique` confirms existing contradiction #4 framing (Stockman's crony-capitalism critique documents the distortion of hard indicators, consistent with `crony-capitalism-and-monetary-deformation` vs. `vibecession`/`economic-literacy`); `economic-literacy-at-scale` cites Kahan's motivated numeracy — consistent with `disposition-vs-knowledge`'s "knowing about biases doesn't automatically counter them" (complementary, not contradictory). All 8 existing contradictions remain open and unchanged. **Stage 2:** 0 new near-duplicate cases. Vault stable at 91 pages since 2026-06-14. Cases 1, 2 (17 confirmed instances), and 3 carry forward unchanged. All pending owner approval. **Stage 3:** All top-tier and mid-tier inbound-link counts re-verified via anchored ripgrep with exact self-only exclusion methodology (exclude only exact self-reference file; prefix-safe exact-string patterns for prefix-vulnerable slugs mental-models, slow-productivity, health-equity, experimental-mindset, jagged-frontier). All 17 counts confirmed stable: disposition-vs-knowledge (20 ✓), mental-models (18 ✓), health-equity (17 ✓), cognitive-atrophy-and-ai (14 ✓), mental-models-and-multidisciplinary-thinking (12 ✓), charlie-munger (11 ✓), slow-productivity (11 ✓), growth-mindset (10 ✓), jagged-frontier (10 ✓), latticework-pedagogy (10 ✓), tuberculosis-and-global-health (10 ✓), experimental-mindset (9 ✓), large-language-models (9 ✓), living-and-working-with-ai (9 ✓), tiny-experiments (8 ✓), stoic-virtues (7 ✓), superforecasting (7 ✓). No rank changes.
...
All pages share a creation band of 2026-05-18 to 2026-06-14 (17–44 days old). Staleness does not yet differentiate meaningfully within this vault; pages are recent. Re-run this section after the next enrichment pass.
...
Inbound-link counts re-verified via anchored ripgrep (exact self-only exclusion — `[[slug]]` and `[[slug|alias]]` forms captured; prefix-safe exact-string pattern for prefix-vulnerable slugs mental-models, slow-productivity, health-equity, experimental-mindset, jagged-frontier). Vault at 91 pages. All counts confirmed stable.
...
Seven pages scanned across Stockman economics cluster (david-stockman, stockman-2008-critique), conceptual tools (focusing-question, inversion), people (anne-laure-le-cunff, jessie-inchauspee), and applied economics (economic-literacy-at-scale). The Stockman economics cluster is internally consistent: `david-stockman` presents Stockman's crony-capitalism/sound-money thesis; `stockman-2008-critique` analyzes the "Blackberry Panic" claim and concludes the intervention was probably necessary while validating Stockman's critique of how it was executed — these two pages are designed to be complementary (the critique page is the wiki's own analysis of a gap in Stockman's argument). No cross-page contradiction; the existing contradiction #4 (bubble-finance/crony-capitalism-and-monetary-deformation vs. vibecession/economic-literacy on hard indicator reliability) already captures the Stockman vs. Scanlon economic framing tension. `economic-literacy-at-scale`'s citation of Kahan's motivated numeracy ("higher statistical literacy increases polarization on contested empirical questions") is consistent with `disposition-vs-knowledge` ("knowing about cognitive biases doesn't automatically counter them") — complementary, not contradictory. `focusing-question` links to [[inversion]] as "a form of forward-reasoning inversion"; `inversion` defines inversion as failure-first reasoning — a terminological looseness in the focusing-question page, but not a substantive cross-page empirical contradiction; not logged. `anne-laure-le-cunff` and `jessie-inchauspee` are well-bounded person pages consistent with their linked concept pages. No new contradictions. All 8 existing contradictions remain open and unchanged.
