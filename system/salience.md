...
**2026-06-24** — Full dream-cycle pass (nightly). 91 wiki pages analyzed (57 concepts, 15 topics, 19 people). Vault unchanged since 2026-06-21 weekly pass. **Stage 1:** 0 new contradictions; 8 total open contradictions confirmed. Pages scanned this run: 8 pages across three clusters — adolescent development/psychology (teenage-girl-development, adolescent-development-in-the-digital-age, developmental-strands), glucose/metabolic health (glucose-revolution, glucose-curves), productivity/Munger (inversion, pseudo-productivity, negotiating-slow-productivity). All pages internally consistent. Two candidates explored: (1) `adolescent-development-in-the-digital-age` (smartphones cause "developmental stagnation in self-regulation" via emotional avoidance) vs. `cognitive-atrophy-and-ai` — confirmed complementary rather than contradictory: both invoke the same mechanism (outsourcing cognitive/emotional work to technology causes atrophy of the underlying capacity), applied to different domains (adolescent self-regulation vs. expert cognitive skill). (2) `glucose-revolution` (caveat: "overall diet pattern almost certainly dominates the ordering effects for most people") vs. `glucose-curves` ("glucose is the highest-leverage single metabolic metric to monitor and manage") — confirmed non-contradictory: glucose-revolution bounds the effect size of specific ordering hacks while glucose-curves focuses on glucose as a monitoring lever; both pages share the same underlying metabolic model. All 8 existing contradictions remain open and unchanged. **Stage 2:** 0 new near-duplicate cases. Vault stable at 91 pages since 2026-06-14. Cases 1, 2 (17 confirmed instances), and 3 carry forward unchanged. All pending owner approval. **Stage 3:** All top-tier and mid-tier inbound-link counts re-verified via exact-string anchored ripgrep (self-reference excluded; prefix inflation avoided). Methodology notes: (a) health-equity: exact-string match required — `health-equity-without-redistribution.md` legitimately links to `[[health-equity]]` and must be included; correct count confirmed at 17. (b) slow-productivity: must not exclude `slow-productivity-and-ai-craft.md` from the inbound count — that file links to `[[slow-productivity]]` and is a valid inbound link; correct count confirmed at 11. (c) jagged-frontier: must not exclude `mapping-the-jagged-frontier.md` from the inbound count — that file links to `[[jagged-frontier]]`; correct count confirmed at 10. All counts stable: disposition-vs-knowledge (20), mental-models (18), health-equity (17), cognitive-atrophy-and-ai (14), mental-models-and-multidisciplinary-thinking (12), charlie-munger (11), slow-productivity (11), growth-mindset (10), jagged-frontier (10), experimental-mindset (9). No rank changes.
...
All pages share a creation band of 2026-05-18 to 2026-06-14 (10–37 days old). Staleness does not yet differentiate meaningfully within this vault; pages are recent. Re-run this section after the next enrichment pass.
...
Inbound-link counts re-verified via exact-string anchored ripgrep (unique files, excluding self-references; exact-string grep used for pages whose names are prefixes of other page names to avoid inflation). Vault at 91 pages. All counts confirmed stable from 2026-06-23.
...
Eight pages scanned across three clusters: adolescent development/psychology (teenage-girl-development, adolescent-development-in-the-digital-age, developmental-strands), glucose/metabolic health (glucose-revolution, glucose-curves), productivity/Munger (inversion, pseudo-productivity, negotiating-slow-productivity). Two candidates explored: (1) `adolescent-development-in-the-digital-age` (smartphone emotional avoidance → developmental stagnation in self-regulation) vs. `cognitive-atrophy-and-ai` (AI assistance → atrophy of cognitive skill) — confirmed complementary: both invoke the same mechanism at different developmental stages and domains; the adolescent development page explicitly cross-references `cognitive-atrophy-and-ai` as the "broader philosophical threat." (2) `glucose-revolution` (caveat that "overall diet pattern almost certainly dominates the ordering effects") vs. `glucose-curves` ("glucose is the highest-leverage single metabolic metric to monitor and manage") — confirmed non-contradictory (already noted in the 2026-06-16 run): the caveat bounds effect size of specific ordering hacks; glucose's monitoring leverage is at a different level of claim. All 8 existing contradictions remain open and unchanged.
...
All inbound-link counts confirmed stable via exact-string anchored ripgrep. Methodology notes documented: (a) health-equity count correctly includes `health-equity-without-redistribution.md` (17 ✓); (b) slow-productivity count correctly includes `slow-productivity-and-ai-craft.md` as an inbound link (11 ✓); (c) jagged-frontier count correctly includes `mapping-the-jagged-frontier.md` (10 ✓). Rankings unchanged. Total open contradictions: **8** (unchanged). Total near-duplicate cases: Cases 1, 2 (17 confirmed), 3 — all pending owner approval.
