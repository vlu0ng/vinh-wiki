...
- **Are there structural differences between people who successfully internalize multi-model reasoning and those who only learn the vocabulary — and can those differences be measured before training?**  
  The evidence is suggestive but not yet strong enough for confident prediction. Several traits correlate with successful internalization: (1) *Need for cognition* — the stable trait of enjoying effortful thinking for its own sake, measured reliably by the Need for Cognition Scale; high-NfC individuals are more likely to spontaneously apply frameworks rather than just recognize them when prompted. (2) *Intellectual humility* — comfort with uncertainty and with being wrong; correlated with belief updating and willingness to hold multiple competing models simultaneously (Leary et al.). (3) *Actively open-minded thinking* (AOT) — the disposition to seek disconfirming evidence and revise beliefs; a consistent predictor of forecasting accuracy in Tetlock's work and of transferable reasoning skill in cognitive science. (4) *Prior cross-domain knowledge* — people who already read across fields have more "hooks" to attach new models to. What's less measurable: intrinsic curiosity and independence from social proof, which seem to be the deepest predictors but are also the hardest to reliably assess pre-training. The practical implication: AOT and NfC scales could be used as selection criteria for programs focused on latticework development, but selection effects are probably stronger than any downstream intervention on measured traits.
